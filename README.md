...
- **When you change a CSS or JS file,** change the `?v=` date on its links in every page (search for `?v=`; a letter on the end, like `?v=20260926b`, is fine for a second change on the same day). This matters most if the host ignores `.htaccess`.
